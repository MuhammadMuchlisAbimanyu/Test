...
Created lists shall be a: 2->3->20->5->10->15 */
	insertLast(&a, "Muchlis", 69, 3.98);
	insertLast(&a, "Dhimas", 68, 3.78);
	insertLast(&a, "Maulana", 70, 3.88);
	insertLast(&a, "Jerry", 67, 3.99);
	/* Sort the above created Linked List */
	cout << "Data Awal :" << endl;
	printList(a);
	cout << "Ascending Merge Sort Nama :" << endl;
	MergeSort(&a);
	printList(a);
	cout << "Ascending Quick Sort Nim :" << endl;
	quickSort(&a);
	printList(a);
	return 0;
}
